...
export const MOCK_SCOPE_DATA: ScopeItem[] = [
  {
    ...
    component: 'queue',
    element: 'order-queue',
    scope_description: 'Order processing queue for handling customer orders',
  },
  {
    scope_id: 'SCO.00002',
    system: 'OMS',
    component: 'database',
    element: 'order-table',
    scope_description: 'Main order table storing all order information',
  },
  {
    scope_id: 'SCO.00003',
    system: 'WMS',
    ...
    scope_description: 'Workflow for order fulfillment and shipping',
  },
  {
    scope_id: 'SCO.00004',
    system: 'SOSC',
    component: 'config',
    element: 'api-timeout',
    scope_description: 'API timeout configuration for external service calls',
  },
];
