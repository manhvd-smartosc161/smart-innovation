...
export const MOCK_TICKETS: MockTicket[] = [
  { id: 'JIRA-001', title: 'Implement user authentication flow' },
  { id: 'JIRA-002', title: 'Fix payment gateway integration bug' },
  { id: 'JIRA-003', title: 'Add responsive design for mobile devices' },
  { id: 'JIRA-004', title: 'Optimize database query performance' },
  { id: 'JIRA-005', title: 'Update user profile page UI' },
  { id: 'JIRA-006', title: 'Implement dark mode theme' },
  { id: 'JIRA-007', title: 'Add email notification system' },
  { id: 'JIRA-008', title: 'Fix cross-browser compatibility issues' },
  { id: 'JIRA-009', title: 'Implement file upload functionality' },
  { id: 'JIRA-010', title: 'Add multi-language support' },
  { id: 'JIRA-011', title: 'Create admin dashboard' },
  { id: 'JIRA-012', title: 'Implement search functionality' },
  { id: 'JIRA-013', title: 'Add data export feature' },
  { id: 'JIRA-014', title: 'Fix security vulnerabilities' },
  { id: 'JIRA-015', title: 'Implement real-time notifications' },
];

export const MOCK_CONFLUENCE_PAGES: MockConfluencePage[] = [
  {
    id: 'CONF-001',
